...
public class Config {
    ...
    public static final String NAMEH_NEW_URL = "http://bemq.ir/newnameh.php";
    public static final String NAMEH_URL = "http://bemq.ir/nameh.php";
    public static final String NAMEH_RECIVE_URL = "http://bemq.ir/recivenameh.php";
    public static final String NAMEH_ERSAL_URL = "http://bemq.ir/ersalnameh.php";
    ...
    public static final String TAG_NNAMEH="nnameh";
    public static final String TAG_MNAMEH="mnameh";
