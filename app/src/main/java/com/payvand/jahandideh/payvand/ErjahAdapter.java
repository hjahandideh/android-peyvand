...
public class ErjahAdapter extends RecyclerView.Adapter<ErjahAdapter.ViewHolder> {
    private static int selectedItem = -1;
    private ImageLoader imageLoader;
    private Context context;
    List<ErjahList> erjahLists;

    public ErjahAdapter(List<ErjahList> erjahLists) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.erjah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ErjahList erjahList = erjahLists.get(position);
                NewNameh.tv.setText(erjahList.geterjah());
